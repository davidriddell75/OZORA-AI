  ...
  return (
    <section className="relative w-full py-32 bg-[rgba(3,18,24,0.95)] text-white overflow-hidden">
      ...
      <div className="relative w-full flex justify-center mt-16 z-10">
        ...
        {/* Big Center Circle */}
        <div className="relative w-[550px] h-[550px] rounded-full 
        ...
        flex items-center justify-center border border-white/5 shadow-[0_0_80px_rgba(3,10,15,0.9)]">
          ...
          {/* Center Logo */}
          <img src="/ozak-logo-gradient.png" alt="center" className="w-44 opacity-95" />

          {/* TOKEN SUPPLY */}
          <div className="absolute -top-10 glass-panel
          ...
          {/* Four floating cards */}
          <div className="absolute -left-56 top-20 glass-panel px-6 py-4 rounded-xl border border-white/10 w-64">
          ...
          <div className="absolute -right-56 top-20 glass-panel px-6 py-4 rounded-xl border border-white/10 w-64">
          ...
          <div className="absolute -left-56 bottom-20 glass-panel px-6 py-4 rounded-xl border border-white/10 w-64">
          ...
          <div className="absolute -right-56 bottom-20 glass-panel px-6 py-4 rounded-xl border border-white/10 w-64">
          ...
          {/* Bottom card */}
          <div className="absolute bottom-[-60px] glass-panel px-6 py-4 rounded-xl border border-white/10 w-64">
      ...
      <div className="text-center mt-28 relative z-10">
        <p className="text-[#9fc4bb] text-xl">Presale Contract Address</p>
        <p className="text-[var(--accent-mint)] font-mono text-2xl">
